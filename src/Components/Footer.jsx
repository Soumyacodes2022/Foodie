...
const Footer = () => {
  ...
  <aside>
    ...
    <p className='my-4 md:w-3/6'>Savor the artistry where every dish is a culinary masterpiece</p>
  </aside> 
  <nav>
