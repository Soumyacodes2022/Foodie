      ...
      <div className='py-24 flex flex-col md:flex-row justify-between items-center gap-8'>
        ...
        <div className='md:w-1/2'>
          ...
          <div className='flex flex-col md:flex-row items-center justify-around -mt-14 gap-5'>
            <div className='flex items-center bg-white px-3 py-2 rounded-md gap-3 shadow-md w-64'>
            ...
            <div className='md:flex hidden items-center bg-white px-3 py-2 rounded-md gap-3 shadow-md w-64'>
              <img src={bfood} alt="" className='rounded-2xl' />
              <div className='space-y-1'>
                <h5 className='font-medium'>Spicy Noodles</h5>
                <div className="rating rating-sm">
