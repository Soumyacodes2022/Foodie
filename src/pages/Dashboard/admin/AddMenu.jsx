...
const AddMenu = () => {
  ...
  const onSubmit = async(data)=>{
    ...
    const imgHost= await axiosPublic.post(image_hosting_api , imageFile , {
      headers:{
    ...
    <div className="w-full md:w-[900px] px-4 mx-auto">
      ...
      <div className="flex flex-col md:flex-row my-12 gap-5">
        ...
        <div className="form-control w-1/2">
          ...
          <select className="select select-bordered w-full" {...register("category",{required:true})} defaultValue="default">
      ...
      <input type="file" className="file-input file-input-bordered w-1/3" {...register("image",{required:true})}/>
      </div>

      {/* 5th Row */}
      
      <button className="btn bg-green text-white hover:text-black w-1/3 md:w-1/6 px-5">Add Item <FaUtensils/> </button>
